    ...
    <div className="contact-container">
      ...
      <div className="contact-form">
        <div className="contact-info">
          <div className="info">
          <p> <FaEnvelope style={{ marginRight: "20px" }} />Email: ajayj11jul1999@gmail.com</p>

          </div>
          <div className="info">
          <p>   <FaPhone style={{ marginRight: "20px" }} />
            Phone: +91 868 2 868 554</p>
          </div>
          <div className="info">
      ...
      <div className="right-links">
        <div className="contact-links">
          ...
          <a
            href="https://github.com/ajayjgit"
            target="_blank"
            rel="noopener noreferrer"
          >
            <svg
